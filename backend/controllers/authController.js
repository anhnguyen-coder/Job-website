...
//Sending OTP code to user's email
export const sendVerifyOtp = async (req, res) => {
  try {
    ...
    const mailOption = {
      ...
      text: `Your OTP is:  ${otp}. Verifying your account by using this OTP`
    }
...
export const sendResetOtp = async (req, res) =>{
  ...
  try {
    ...
    const mailOption = {
      ...
      text: `Your OTP is:  ${otp}. It is valid for 15 minutes. Use this OTP to reset your password`
    }
